...
class AutoCenter:MeteorModule(HighwayTools.MAIN, "AutoCenter", "Automatically centers the player so that NetherBorer mines on axis.") {
    ...
    override fun onActivate() {
        ...
        this.highway = highwaytools.highway
    }
