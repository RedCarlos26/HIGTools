...
import higtools.modules.borers.PosNegBorer;
...
public class PosNegDigging extends Module {

    public PosNegDigging() { super(HIGTools.TOGGLES, "PosNeg-digging", "Turns on the necessary modules to dig the +X -Z highway."); }
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        modules.get(PosNegDigging.class).toggle();
    }
}
