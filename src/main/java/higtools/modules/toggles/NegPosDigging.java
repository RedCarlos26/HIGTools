...
import higtools.modules.borers.NegPosBorer;
...
public class NegPosDigging extends Module {

    public NegPosDigging() { super(HIGTools.TOGGLES, "NegPos-digging", "Turns on the necessary modules to dig the -X +Z highway."); }
