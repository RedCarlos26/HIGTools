...
public class DiscordRPC extends Module {
    ...
    public DiscordRPC() {
        super(HighwayTools.MAIN, "discord-RPC", "Displays HighwayTools Meteor as your presence on discord.");
        runInMainMenu = true;
    }
    ...
    public void onActivate() {
        ...
        String largeText = "HighwayTools Meteor";
        rpc.setLargeImage("highwaytools", largeText);
    ...
    private void onTick(TickEvent.Post event) {
        ...
        if (Utils.canUpdate()) {
            ...
            if (!lastWasInMainMenu) {
                rpc.setDetails("HighwayTools-Meteor " + HighwayTools.VERSION);
